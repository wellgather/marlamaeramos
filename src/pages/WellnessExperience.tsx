      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {[
            ...
            { q: "Integration & Guidance", a: "If guests come once but don’t return, I help you design experiences that build real connection so you can grow a loyal community that keeps coming back and engaging with your brand." },
