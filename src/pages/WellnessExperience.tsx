      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {[
            ...
            { q: "Building a Repeat Wellness Community", a: "If your delivery relies too much on individuals and lacks consistency, I give you a structured system your team can follow, refine, and scale so your wellness offering becomes stronger, more consistent, and easier to grow over time." },
            { q: "Revenue-Driven Experience Strategy", a: "If guests come once but don’t return, I help you design experiences that build real connection so you can grow a loyal community that keeps coming back and engaging with your brand." },
