    ...
    <section id="offer" className="container py-24">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {[
          ...
          { icon: MessageCircle, title: "Playbook", desc: "Daily access to me between our sessions." },
    ...
    <section className="container py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {[
            { q: "Expert-Led Industry Perspective", a: "If you feel unsure what actually works in wellness and worry your offering may come across as generic or inauthentic, I guide you with real industry insight so you can create experiences that truly resonate, convert, and avoid wellness washing that today’s consumers can easily recognise." },
            { q: "Strategic Experience Design & Positioning", a: "If your wellness offering feels scattered or lacks depth, I help you shape it into a clear, intentional experience that flows seamlessly, avoids activities that don’t truly fit your brand, stands out in your market, and creates real impact for your guests." },
            { q: "SOP Framework & Compounding Knowledge", a: "If your delivery relies too much on individuals and lacks consistency, I give you a structured system your team can follow, refine, and scale so your wellness offering becomes stronger, more consistent, and easier to grow over time." },
            { q: "Building a Repeat Wellness Community", a: "If guests come once but don’t return, I help you design experiences that build real connection so you can grow a loyal community that keeps coming back and engaging with your brand." },
            { q: "Revenue-Driven Experience Strategy", a: "If your wellness offering is not generating the revenue or long term value you expected, I help you uncover missed opportunities and design experiences that attract the right audience, convert better, and increase lifetime value, while guiding you on how to price your offerings confidently and build healthy, aligned partnerships whether you are a facilitator, brand manager, or retreat organizer, all tailored to your unique signature experience and brand identity. " },
          ].map((item, i) => (
            <AccordionItem
              key={i}
              value={`item-${i}`}
