        ...
        <div className="container py-20 md:py-32 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto leading-relaxed">
              ...
              practices designed to help you heal and regenerate the planet. See the experiences in Wellgather - our social wellness platform where you can find, book, share and organize your own wellness activities.
            </p>
            <div className="pt-4">
